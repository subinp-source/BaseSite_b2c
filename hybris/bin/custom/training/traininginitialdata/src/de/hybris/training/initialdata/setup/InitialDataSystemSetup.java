...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		sampleImportData.setProductCatalogName(MOBILE);
		sampleImportData.setContentCatalogNames(Arrays.asList(MOBILE));
		sampleImportData.setStoreNames(Arrays.asList(MOBILE));
